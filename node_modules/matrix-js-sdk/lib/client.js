...
var _setDeviceVerification = function () {
    var _ref4 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee2(client, userId, deviceId, verified, blocked, known) {
        var dev;
 ...
 */
MatrixClient.prototype.initCrypto = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee() {
    var userId, crypto;
    return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                ...
                case 14:
                    crypto = new Crypto(this, this._sessionStore, userId, this.deviceId, this.store, this._cryptoStore);


                    this.reEmitter.reEmit(crypto, ["crypto.roomKeyRequest", "crypto.roomKeyRequestCancellation"]);
...
MatrixClient.prototype.isEventSenderVerified = function () {
    var _ref6 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee3(event) {
        var device;
            ...
            (function () {
                ...
                callEventBuffer.forEach(function (e) {
                    if (ignoreCallIds[e.getContent().call_id]) {
                        console.log('Ignoring previously answered/hungup call ' + e.getContent().call_id);
                        return;
                    }
                    callEventHandler(e);
                });
