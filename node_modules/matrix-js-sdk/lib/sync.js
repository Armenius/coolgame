...
SyncApi.prototype._sync = function () {
    var _ref = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee(syncOptions) {
        var client, filterId, syncToken, pollTimeout, clientSideTimeoutMs, qps, savedSync, isCachedResponse, data, syncEventData;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 6:
                        ...
                        clientSideTimeoutMs = pollTimeout + BUFFER_PERIOD_MS;
                        qps = {
                            filter: filterId,
                            timeout: pollTimeout
                        };
                        ...
                        _context.next = 19;
                        return (0, _bluebird.resolve)(client.store.getSavedSync());

                    case 19:
                        savedSync = _context.sent;
                    ...
                    case 35:
                        ...
                        this._onSyncError(_context.t0, syncOptions);
                        return _context.abrupt("return");
                    ...
                    case 44:
                        _context.prev = 44;
                        _context.next = 47;
                        return (0, _bluebird.resolve)(this._processSyncResponse(syncToken, data));
                    ...
                    case 49:
                        ...
                        console.error("Caught /sync error", _context.t1.stack || _context.t1);
...
SyncApi.prototype._processSyncResponse = function () {
    var _ref2 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee4(syncToken, data) {
                ...
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        return (0, _bluebird.resolve)(_bluebird2.default.mapSeries(joinRooms, function () {
                            var _ref3 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee3(joinObj) {
                                var processRoomEvent = function () {
                                    var _ref4 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee2(e) {
                                    ...
                                    return function processRoomEvent(_x5) {
                                        ...
                                        switch (_context3.prev = _context3.next) {
                                            ...
                                            case 24:
                                                ...
                                                if (limited) {
                                                    ...
                                                    room.resetLiveTimeline(joinObj.timeline.prev_batch, self.opts.canResetEntireTimeline(room.roomId) ? null : syncToken);
                    ...
                    case 14:
                        ...
                        _context4.next = 20;
                        return (0, _bluebird.resolve)(this.opts.crypto.handleDeviceListChanges(data.device_lists));
